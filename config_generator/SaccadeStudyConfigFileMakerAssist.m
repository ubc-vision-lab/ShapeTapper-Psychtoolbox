function [A,B,C,D,E,F,G,H] = SaccadeStudyConfigFileMakerAssist
...
A{15,1} = 'stim_sound_file'; %s
A{16,1} = 'stim_onset'; %f
A{17,1} = 'stim_duration'; %f
A{18,1} = 'stim_cent_x'; %f
A{19,1} = 'stim_cent_y'; %f
A{20,1} = 'stim_size_x'; %f
A{21,1} = 'stim_size_y'; %f
A{22,1} = 'stim_rotation'; %f
A{23,1} = 'stim_is_touchable'; %u
A{24,1} = 'stim_is_target'; %u
A{25,1} = 'subj_fixation_type'; %u
A{26,1} = 'subj_fixation_pause'; %u
A{27,1} = 'subj_fixation_onset'; %f
A{28,1} = 'subj_fixation_duration'; %f
A{29,1} = 'mask_onset'; %f
A{30,1} = 'mask_duration'; %f
A{31,1} = 'mask_size'; %f
A{32,1} = 'mask_color'; %f
A{33,1} = 'mask_rotation'; %f
A{34,1} = 'mask_fit'; %u
A{35,1} = 'mask_margin'; %f
...
C = ['%u,%u,%u,%f,%u,%f,%u,%u,%s,%u,%s,%s,%s,%s,%s,%f,%f,%f,%f,%f,%f,%f,%u,%u,%u,%u,%f,%f,%f,'...
    '%f,%f,%f,%f,%u,%f\r\n'];

%format specifier for reading-in the config file
D = '%u%u%u%f%u%f%u%u%s%u%s%s%s%s%s%f%f%f%f%f%f%f%u%u%u%u%f%f%f%f%f%f%f%u%f';
